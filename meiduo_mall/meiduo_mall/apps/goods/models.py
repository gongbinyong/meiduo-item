...
# from utils.models import BasrModel
from meiduo_mall.utils.models import BasrModel

# Create your models here.
class GoodsCategory(BasrModel):
    """
    商品类别
    """
...
class GoodsSpecification(BasrModel):
    """
    商品规格
    """
...
class SpecificationOption(BasrModel):
    """
    规格选项
    """
...
class SKUSpecification(BasrModel):
    """
    SKU具体规格
    """
    sku = models.ForeignKey(SKU, on_delete=models.CASCADE, verbose_name='sku')
